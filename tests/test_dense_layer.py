...
class DenseLayerTestCase(unittest.TestCase):
  ...
  def test_dense_layer_foward(self):
    ...
    dense_layer = DenseLayer(num_of_neurons=4, activation=identity)
    dense_layer.set_previus_layer(input_layer)
    ...
    expected_pre_activation = np.array([[0.02284811, 0.20783381, 0.27520068, 0.03072228, -0.0693488 ],
                                        [0.0380068 , 0.16405706, 0.20668625, 0.01825064, -0.04060021],
                                        [0.01498334, 0.1653724 , 0.17115901, 0.09844282, -0.08420087]])
    expected_pos_activation = np.array([[0.02284811, 0.20783381, 0.27520068, 0.03072228, -0.0693488 ],
                                        [0.0380068 , 0.16405706, 0.20668625, 0.01825064, -0.04060021],
                                        [0.01498334, 0.1653724 , 0.17115901, 0.09844282, -0.08420087]])
  ...
  def test_dense_layer_backward(self):
    ...
    output_layer = Layer()
    output_layer.gradient = np.array([[0.58065229, 0.07073203, 0.99459365, 0.95053096, 0.67950329],
    ...
    dense_layer.weights = np.array([[-0.04653779, -0.0469091 , -0.25623124,  0.16194522, -0.07224174],
                                    ...
                                    [ 0.02374537, -0.02832615,  0.12901608,  0.02934764,  0.10403082]])
    dense_layer.bias = np.array([0.04222229,  0.12840084,  0.04837644, -0.01436746, -0.07240851])
    dense_layer.pre_activation = np.array([[0.02284811, 0.20783381, 0.27520068, 0.03072228, -0.0693488 ],
                                           [0.0380068 , 0.16405706, 0.20668625, 0.01825064, -0.04060021],
                                           [0.01498334, 0.1653724 , 0.17115901, 0.09844282, -0.08420087]])
